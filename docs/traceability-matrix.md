...
| ------- | -------- | ---------------------------------- | --------------------------------------------------------------- | ------------------- | ------- |
| REQ-001 | US-001.1 | AC-001.1 — Successful Registration | `test_successful_registration`                                  | API                 | Partial |
| REQ-001 | US-001.1 | AC-001.2 — Duplicate Email         | `test_registration_with_duplicate_email`                        | API                 | Partial |
| REQ-001 | US-001.1 | AC-001.3 — Invalid Email           | `test_registration_with_invalid_email`                          | API                 | Partial |
| REQ-001 | US-001.1 | AC-001.4 — Invalid Password        | `test_registration_with_short_password`                         | API                 | Partial |
| REQ-001 | US-001.1 | AC-001.4 — Invalid Password        | `test_registration_without_uppercase_password`                  | API                 | Partial |
| REQ-001 | US-001.1 | AC-001.4 — Invalid Password        | `test_registration_without_lowercase_password`                  | API                 | Partial |
| REQ-001 | US-001.1 | AC-001.4 — Invalid Password        | `test_registration_without_number_password`                     | API                 | Partial |
...
| REQ-003 | US-003.1 | AC-003.3 — Invalid Authentication | `test_invalid_token_cannot_access_protected_endpoint`        | API / Security | Partial |
...
| REQ-005 | US-005.1 | AC-005.2 — Invalid Project Name         | `test_create_project_with_empty_name`                  | API       | Partial |
| REQ-005 | US-005.1 | AC-005.2 — Invalid Project Name         | `test_project_creation_rejects_whitespace_only_name`     | API       | Partial |
...
| REQ     | US       | AC                                           | Automated Test                                     | Test Type      | Status  |
| ------- | -------- | -------------------------------------------- | -------------------------------------------------- | -------------- | ------- |
| REQ-007 | US-007   | AC-007.1 — Successful Project Name Editing   | `test_edit_project_name`                           | API            | Partial |
| REQ-007 | US-007   | AC-007.2 — Unauthorized Project Name Editing | `test_user_cannot_edit_another_users_project_name` | API / Security | Covered |

### REQ-008 — Project Deletion

| REQ     | US       | AC                                        | Automated Test                                                   | Test Type                  | Status  |
| ------- | -------- | ----------------------------------------- | ---------------------------------------------------------------- | -------------------------- | ------- |
| REQ-008 | US-008   | AC-008.1 — Successful Project Deletion    | `test_delete_project`                                            | API                        | Partial |
| REQ-008 | US-008   | AC-008.1 — Successful Project Deletion    | `test_new_project_owner_cannot_access_bugs_from_deleted_project` | API / Database / Security  | Partial |
| REQ-008 | US-008   | AC-008.2 — Unauthorized Project Deletion  | `test_user_cannot_delete_another_users_project`                  | API / Security             | Covered |
...
| REQ     | US       | AC                              | Automated Test                                                    | Test Type        | Status  |
| ------- | -------- | ------------------------------- | ----------------------------------------------------------------- | ---------------- | ------- |
| REQ-009 | US-009   | AC-009.1 — Add Member           | `test_owner_can_add_project_member`                               | API / Validation | Partial |
| REQ-009 | US-009   | AC-009.1 — Add Member           | `test_added_member_can_access_project`                            | API / Security   | Partial |
| REQ-009 | US-009   | AC-009.2 — Remove Member        | `test_owner_can_remove_project_member`                            | API              | Partial |
| REQ-009 | US-009   | AC-009.2 — Remove Member        | `test_removed_member_can_no_longer_access_project`                | API / Security   | Partial |
| REQ-009 | US-009   | AC-009.2 — Remove Member        | `test_removing_member_unassigns_only_their_bugs_in_that_project`   | API              | Partial |
| REQ-009 | US-009   | AC-009.3 — Invalid Member       | `test_project_owner_cannot_add_user_who_does_not_have_an_account` | API / Validation | Covered |
| REQ-009 | US-009   | AC-009.4 — Duplicate Member     | `test_project_owner_cannot_add_same_user_more_than_once`          | API / Validation | Covered |
| REQ-009 | US-009   | AC-009.5 — View Project Members | `test_project_member_can_view_project_members`                    | API / Security   | Partial |
| REQ-009 | US-009   | —                               | `test_project_owner_cannot_remove_themselves`                     | API / Security   | Covered |
...
| REQ     | US       | AC                                                | Automated Test                                 | Test Type      | Status  |
| ------- | -------- | ------------------------------------------------- | ---------------------------------------------- | -------------- | ------- |
| REQ-010 | US-010   | AC-010.1 — Project Owner Role                     | `test_project_creator_is_project_owner`        | API / Security | Covered |
| REQ-010 | US-010   | AC-010.2 — QA Analyst Role                        | `test_qa_analyst_can_access_project`           | API / Security | Covered |
| REQ-010 | US-010   | AC-010.3 — Developer Role                         | `test_developer_can_access_project`            | API / Security | Covered |
| REQ-010 | US-010   | AC-010.4 — Unauthorized Project Member Management | `test_non_owner_cannot_manage_project_members` | API / Security | Covered |
| REQ-010 | US-010   | AC-010.5 — Unauthorized Project Actions           | `test_non_owner_cannot_edit_project`           | API / Security | Covered |
| REQ-010 | US-010   | AC-010.5 — Unauthorized Project Actions           | `test_non_owner_cannot_delete_project`         | API / Security | Covered |
...
| REQ | US | AC | Automated Test | Test Type | Status |
|---|---|---|---|---|---|
| REQ-011 | US-011 | AC-011.1 — Successful Bug Creation | `test_project_member_can_create_bug` | API | Partial |
| REQ-011 | US-011 | AC-011.2 — Missing Bug Title | `test_bug_creation_rejected_without_title` | API / Validation | Partial |
| REQ-011 | US-011 | AC-011.3 — Unauthorized Bug Creation | `test_non_member_cannot_create_bug` | API / Security | Covered |
| REQ-011 | US-011 | AC-011.4 — Optional Bug Information | `test_bug_can_be_created_with_optional_information` | API / Validation | Partial |
...
| REQ | US | AC | Automated Test | Test Type | Status |
|---|---|---|---|---|---|
| REQ-012 | US-012 | AC-012.1 — View Bug List | `test_project_member_can_view_bug_list` | API | Partial |
| REQ-012 | US-012 | AC-012.2 — Open Bug Report | `test_project_member_can_open_bug_report` | API | Partial |
...
| REQ | US | AC | Automated Test | Test Type | Status |
|---|---|---|---|---|---|
| REQ-013 | US-013 | AC-013.1 — Edit Bug Report | `test_project_member_can_edit_bug_report` | API | Partial |
| REQ-013 | US-013 | AC-013.2 — Optional Bug Information | `test_project_member_can_update_optional_bug_information` | API / Validation | Partial |
...
| REQ-014 | US-014 | AC-014.1 — Successful Bug Deletion | — | UI | Pending |
...
| REQ-015 | US-015 | AC-015.4 — Change Bug Assignee | `test_authorized_member_can_reassign_bug` | API | Partial |
...
| REQ-017 | US-017 | AC-017.3 — Open to Development | `test_assigned_developer_can_move_bug_from_development_to_testing` | API | Partial |
...
- User-story references for REQ-007 through REQ-010 now match the existing requirements headings. REQ-005 still references US-005.1 in this matrix, but requirements.md has no corresponding user-story heading. Resolving that missing specification needs review; no new ID is introduced here.
